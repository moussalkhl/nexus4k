...
export const metadata: Metadata = genMeta({
  ...
  description: 'Nexus 4K IPTV: 30,000+ live channels, sports & movies in UHD. Join 20,000+ happy streamers. Get your premium IPTV subscription and free trial today!',
  canonical: '/',
  keywords: [
    'Nexus 4K IPTV',
    'Nexus4kTV',
