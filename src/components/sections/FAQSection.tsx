...
const FAQ_ITEMS = [
  {
    question: 'What is IPTV and how does Nexus4kTV work?',
    answer:
      'IPTV (Internet Protocol Television) delivers live TV channels and on-demand content over the internet. Nexus4kTV provides a subscription-based service with 30,000+ channels streamed via our premium server network to any device.',
  },
  {
    question: 'Which devices are compatible with Nexus4kTV?',
    answer:
      'Nexus4kTV works on Smart TVs (Samsung, LG, Sony), Amazon Firestick, Android TV boxes, Android & iOS phones/tablets, Windows and Mac computers, MAG boxes, Formuler, and any IPTV player app.',
  },
  {
  ...
  {
    question: 'Is Nexus4kTV available worldwide?',
    answer:
      'Yes. Nexus4kTV operates globally across 150+ countries. Our CDN infrastructure ensures low-latency, buffer-free streaming regardless of your location.',
  },
  {
    question: 'Can I try Nexus4kTV before subscribing?',
    answer:
        ...
        <div className={styles.inner}>
          ...
          <div className={styles.left}>
            ...
            <h2 className="section-title" id="faq-heading">
              Frequently Asked Questions About <span className="text-gradient">Nexus4kTV</span>
            </h2>
            <p className={styles.subtitle}>
              Everything you need to know about Nexus4kTV. Can&apos;t find your
