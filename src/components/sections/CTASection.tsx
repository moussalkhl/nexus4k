        ...
        <div className={styles.ctaCard}>
          ...
          <div className={styles.cardContent}>
            ...
            <div className={styles.btnGroup}>
              <Link href={`https://wa.me/${siteConfig.whatsappNumber}?text=Hi!%20I%27m%20ready%20to%20upgrade%20my%20entertainment%20with%20a%20premium%20Nexus%204K%20IPTV%20subscription.%20How%20can%20I%20get%20started%3F`} target="_blank" rel="noopener noreferrer" className={styles.primaryBtn} title="Activate your Nexus IPTV subscription on WhatsApp">
                Activate IPTV Now
              </Link>
